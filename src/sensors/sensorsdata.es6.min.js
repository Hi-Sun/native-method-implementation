...
(function () {
  ...
  var r = t.JSON,
    ...
    a = (function n(r, s) {
      ...
      var i = r.Number || t.Number,
        ...
        u = r.Math || t.Math,
        p = r.JSON || t.JSON;
      'object' == typeof p && p && ((s.stringify = p.stringify), (s.parse = p.parse));
      var _,
        g = o.prototype,
        f = g.toString,
        h = g.hasOwnProperty;
            ...
            return (
              ...
              n
                ? (b = function (e, t) {
                    var r,
                      s,
                      i = '[object Function]' == f.call(e);
                    for (r in e)
                      (i && 'prototype' == r) || !h.call(e, r) || (s = 'constructor' === r) || t(r);
                    ...
                    var s,
                      ...
                      o =
                        (!n &&
                          ...
                          t.hasOwnProperty) ||
                        h;
                    for (s in t) (n && 'prototype' == s) || !o.call(t, s) || r(s);
                    for (a = i.length; (s = i[--a]); ) o.call(t, s) && r(s);
                  })),
              b(t, r)
            );
          };
        if (!y('json-stringify') && !y('date-serialization')) {
          var w = { 92: '\\\\', 34: '\\"', 8: '\\b', 12: '\\f', 10: '\\n', 13: '\\r', 9: '\\t' },
            ...
            P = function (e) {
              ...
              if (v)
                ...
                t = function (e) {
                  for (i = l(e / 864e5), r = l(i / 365.2425) + 1970 - 1; _(r + 1, 0) <= i; r++);
                  for (s = l((i - _(r, 0)) / 30.42); _(r, s + 1) <= i; s++);
                  (i = 1 + i - _(r, s)),
                    (n = l((a = ((e % 864e5) + 864e5) % 864e5) / 36e5) % 24),
                    (o = l(a / 6e4) % 60),
                    (d = l(a / 1e3) % 60),
                    (c = a % 1e3);
                };
          ...
          if (y('json-stringify') && !y('date-serialization')) {
            ...
            var D = function (e) {
              ...
              N = function (e, t, r, s, i, a, n) {
                var o, c, u, p, g, h, v, y, S;
                if (
                  (m(function () {
                    o = t[e];
                  }),
                  ...
                  return o === _ ? o : 'null';
                switch (('object' == (c = typeof o) && (u = f.call(o)), u || c)) {
                  case 'boolean':
                  case '[object Boolean]':
                    return '' + o;
                  case 'number':
                ...
                if ('object' == typeof o) {
                  ...
                  if ((n.push(o), (p = []), (y = a), (a += i), '[object Array]' == u)) {
                    for (h = 0, v = o.length; h < v; h++)
                      (g = N(h, o, r, s, i, a, n)), p.push(g === _ ? 'null' : g);
                    S = p.length
                      ? i
                        ? '[\n' + a + p.join(',\n' + a) + '\n' + y + ']'
                        : '[' + p.join(',') + ']'
            ...
            s.stringify = function (t, r, s) {
              var i, a, n, o;
              if (e[typeof r] && r)
                if ('[object Function]' == (o = f.call(r))) a = r;
                else if ('[object Array]' == o) {
                  n = {};
                  for (var d, c = 0, l = r.length; c < l; )
                    (d = r[c++]),
                      ('[object String]' != (o = f.call(d)) && '[object Number]' != o) ||
                        (n[d] = 1);
                }
              if (s)
                if ('[object Number]' == (o = f.call(s))) {
                  if ((s -= s % 1) > 0) for (s > 10 && (s = 10), i = ''; i.length < s; ) i += ' ';
                } else '[object String]' == o && (i = s.length <= 10 ? s : s.slice(0, 10));
              return N('', (((d = {})[''] = t), d), a, n, i, '', []);
            };
          }
        }
        if (!y('json-parse')) {
          var E,
            ...
            T = function () {
              for (var e, t, r, s, i, a = L, n = a.length; E < n; )
                switch ((i = a.charCodeAt(E))) {
                  case 9:
                  case 10:
                  case 13:
                  case 32:
                  ...
                  case 58:
                  case 44:
                    return (e = S ? a.charAt(E) : a[E]), E++, e;
                  case 34:
                    for (e = '@', E++; E < n; )
                      if ((i = a.charCodeAt(E)) < 32) x();
                      else if (92 == i)
                        switch ((i = a.charCodeAt(++E))) {
                          case 92:
                          case 34:
                        ...
                        if (34 == i) break;
                        for (i = a.charCodeAt(E), t = E; i >= 32 && 92 != i && 34 != i; )
                          i = a.charCodeAt(++E);
                        e += a.slice(t, E);
                      }
                    if (34 == a.charCodeAt(E)) return E++, e;
                    x();
                  default:
                    if (
                      ((t = E), 45 == i && ((s = !0), (i = a.charCodeAt(++E))), i >= 48 && i <= 57)
                    ) {
                      for (
                        48 == i && (i = a.charCodeAt(E + 1)) >= 48 && i <= 57 && x(), s = !1;
                        E < n && (i = a.charCodeAt(E)) >= 48 && i <= 57;
                        E++
                      );
                      if (46 == a.charCodeAt(E)) {
                        for (r = ++E; r < n && !((i = a.charCodeAt(r)) < 48 || i > 57); r++);
                        r == E && x(), (E = r);
                      }
                      if (101 == (i = a.charCodeAt(E)) || 69 == i) {
                        for (
                          (43 != (i = a.charCodeAt(++E)) && 45 != i) || E++, r = E;
                          r < n && !((i = a.charCodeAt(r)) < 48 || i > 57);
                          r++
                        );
                        r == E && x(), (E = r);
                      }
                    ...
                    if ('fals' == o && 101 == a.charCodeAt(E + 4)) return (E += 5), !1;
            ...
            B = function (e, t, r) {
              ...
              if ('object' == typeof i && i)
                if ('[object Array]' == f.call(i)) for (s = i.length; s--; ) R(f, b, i);
                else
                  b(i, function (e) {
                    R(i, e, r);
                  });
          ...
          s.parse = function (e, t) {
            ...
            return (
              ...
              '$' != T() && x(),
              (E = L = null),
              t && '[object Function]' == f.call(t) ? B((((s = {})[''] = r), s), '', t) : r
            );
          };
        }
      }
      ...
      (t.JSON3 = {
        noConflict: function () {
          return i || ((i = !0), (t.JSON = r), (t.JSON3 = s), (r = s = null)), a;
        },
      })
    );
  ...
  (function (e) {
    if (e.atob)
      ...
      (e.btoa = function (e) {
        e = String(e);
        for (var t, r, i, a, n = '', o = 0, d = e.length % 3; o < e.length; ) {
          if (
...
function each(e, t, r) {
  ...
  if (nativeForEach && e.forEach === nativeForEach) e.forEach(t, r);
    ...
    for (var a in e) if (hasOwnProperty.call(e, a) && t.call(r, e[a], a, e) === breaker) return !1;
}
function map(e, t) {
  var r = [];
  return null == e
...
function throttle(e, t, r) {
  ...
  r || (r = {});
  var d = function () {
    (o = !1 === r.leading ? 0 : now()), (n = null), (a = e.apply(s, i)), n || (s = i = null);
  };
  return function () {
    var c = now();
    o || !1 !== r.leading || (o = c);
    ...
    return (
      ...
      (i = arguments),
      l <= 0 || l > t
        ? (n && (clearTimeout(n), (n = null)), (o = c), (a = e.apply(s, i)), n || (s = i = null))
...
function unique(e) {
  for (var t, r = [], s = {}, i = 0; i < e.length; i++) (t = e[i]) in s || ((s[t] = !0), r.push(t));
  return r;
}
...
function rot13obfs(e, t) {
  ...
  for (var r = (e = String(e)).split(''), s = 0, i = r.length; s < i; s++) {
...
function dfmapping(e) {
  var t = 't6KJCZa5pDdQ9khoEM3Tj70fbP2eLSyc4BrsYugARqFIw1mzlGNVXOHiWvxUn8',
    ...
    s = {},
    i = 0;
  for (i = 0; i < t.length; i++) s[t.charAt(i)] = t.charAt(r - i);
  var a = '';
  for (i = 0; i < e.length; i++) e.charAt(i) in s ? (a += s[e.charAt(i)]) : (a += e.charAt(i));
  return a;
}
function strToUnicode(e, t) {
  if ('string' != typeof e) return t('\u8f6c\u6362unicode\u9519\u8bef', e), e;
  for (var r = '', s = 0; s < e.length; s++) r += '\\' + e.charCodeAt(s).toString(16);
  return r;
}
var sdPara = {},
  defaultPara = {
...
function sdLog() {
  if (
    ((isSessionStorgaeSupport() && 'true' === sessionStorage.getItem('sensorsdata_jssdk_debug')) ||
      sdPara.show_log) &&
      ...
      t = (function (e, t) {
        ...
        if (0 === e.indexOf('#')) (e = e.slice(1)), (r = document.getElementById(e));
          ...
          for (var o = t.children, d = 0; d < o.length; d++)
            if (isElement(o[d]) && o[d].tagName.toLowerCase() === i && 0 == --n) {
              r = o[d];
              break;
            }
          if (n > 0) return null;
...
(ry.init = function (e) {
  ...
  (ry.init.prototype = {
    ...
    getSameTypeSiblings: function () {
      for (
        var e = this.ele, t = e.parentNode, r = e.tagName.toLowerCase(), s = [], i = 0;
        i < t.children.length;
        i++
      ) {
        var a = t.children[i];
        1 === a.nodeType && a.tagName.toLowerCase() === r && s.push(t.children[i]);
      }
      return s;
    },
    getParents: function () {
...
function urlParse(e) {
  ...
  return (
    ...
    (t.prototype._parse = function (e) {
      ...
      for (var r in (t || sdLog('DPURLParser::_parse -> Invalid URL'), this._fields))
    ...
    var r =
      ...
      (function () {
        ...
        function a(e, t) {
          var r,
            i = 0;
          for (r = 0; r < t.length; r++) i |= s[r] << (8 * r);
          return e ^ i;
        }
        for (e = 0; e < r.length; e++)
          (t = r.charCodeAt(e)), s.unshift(255 & t), s.length >= 4 && ((i = a(i, s)), (s = []));
        return s.length > 0 && (i = a(i, s)), i.toString(16);
      })() +
      '-' +
      t +
      '-' +
    ...
    for (var s = '.' + r.splice(r.length - 1, 1); r.length > 0; )
      if (
        ...
        return (
          ...
          (document.cookie =
            'sensorsdata_domain_test=true; expires=' + i.toGMTString() + '; path=/; domain=' + s),
          s
        );
      }
  return '';
...
function getReferrer(e, t) {
  return 'string' != typeof (e = e || document.referrer)
    ...
    : (0 !== (e = _decodeURI(e)).indexOf('https://www.baidu.com/') || t || (e = e.split('?')[0]),
...
function getReferSearchEngine(e) {
  ...
  for (var s in r) for (var i = r[s], a = 0, n = i.length; a < n; a++) if (i[a].test(t)) return s;
  return '\u672a\u77e5\u641c\u7d22\u5f15\u64ce';
}
...
function getWxAdIdFromUrl(e) {
  ...
  return (
    isString(t) &&
      ...
      isString(s) && s.length && (i.callbacks = s)),
    i
  );
}
var pageInfo = {
...
var cookie = {
    ...
    set: function (e, t, r, s) {
      var i = '',
        ...
        n = '',
        o = '';
      if (((r = null == r ? 73e3 : r), (s = void 0 === s ? sdPara.cross_subdomain : s))) {
      ...
      e && (u = l(e)),
        t && (p = l(t)),
        i && (_ = l(i)),
        u && p && (document.cookie = u + '=' + encodeURIComponent(p) + a + '; path=/' + _ + o + n);
    },
    encrypt: function (e) {
      return 'dfm-enc-' + dfmapping(e);
    },
    decrypt: function (e) {
      return (
        0 === e.indexOf('data:enc;')
          ? (e = rot13defs((e = e.substring('data:enc;'.length))))
          : 0 === e.indexOf('dfm-enc-') && (e = dfmapping((e = e.substring('dfm-enc-'.length)))),
        e
      );
    },
    resolveValue: function (e) {
      return (
        !isString(e) ||
          (0 !== e.indexOf('data:enc;') && 0 !== e.indexOf('dfm-enc-')) ||
          (e = cookie.decrypt(e)),
        e
      );
    },
      ...
      t[a] = (function (t, r, s, i) {
        return function (a) {
          ...
          var n,
            ...
            d = !0;
          return (
            'function' == typeof s && (n = s(a)),
            (o = r.call(t, a)),
            'beforeunload' !== i ? ((!1 !== n && !1 !== o) || (d = !1), d) : void 0
          );
        };
      })(t, s, n, r);
    }
...
function addSinglePageEvent(e) {
  ...
  isFunction(window.history.pushState) &&
    ...
    (t = window.document.documentMode ? 'hashchange' : s ? 'popstate' : 'hashchange'),
...
function bindReady(e, t) {
  ...
  var r = !1,
    ...
    c = n ? '' : 'on',
    l = function (s) {
      ('readystatechange' == s.type && 'complete' != i.readyState) ||
        (('load' == s.type ? t : i)[d](c + s.type, l, !1),
  ...
  if ('complete' == i.readyState) e.call(t, 'lazy');
    ...
    i[o](c + 'DOMContentLoaded', l, !1),
      i[o](c + 'readystatechange', l, !1),
      t[o](c + 'load', l, !1);
  }
}
function xhr(e) {
...
var _ = {
  ...
  saNewUser = {
      ...
      null != (r = cookie.resolveValue(r)) &&
        ...
        !0 === sd.para.cross_subdomain
          ...
          : ((s.$device_id = t),
            ...
            cookie.set('sensorsdata2015jssdkcross' + sd.para.sdk_id, s, null, !0)),
    ...
    storeInitCheck: function () {
      if (sd.is_first_visitor) {
        ...
        cookie.set(cookie.getCookieName('new_user'), '1', 3600 * t.h + 60 * t.m + t.s + 's'),
    ...
    checkIsFirstLatest: function () {
      ...
      if (
        ...
        each(sd.para.preset_properties, function (r, s) {
          ...
          else if ('wx_ad_click_id' == s && sd.store._state && sd.store._state.props && !1 === r) {
            each(
        ...
        var s = pageInfo.campaignParamsStandard('$latest_', '_latest_'),
          i = s.$utms,
          a = s.otherUtms;
        isEmptyObject(i) || sd.register(i), isEmptyObject(a) || sd.register(a);
      }
    },
  },
  store = {
    identities: {
      set: function (e, t) {
        ...
        switch (e) {
          case 'login':
            (r[sd.para.login_id_key] = t),
              (r.$identity_cookie_id = sd.store._state.identities.$identity_cookie_id);
            break;
          case 'logout':
            r.$identity_cookie_id = sd.store._state.identities.$identity_cookie_id;
            break;
          case 'identify':
            (r = JSON.parse(JSON.stringify(sd.store._state.identities))).$identity_anonymous_id = t;
        }
        (sd.store._state.identities = r), sd.store.save();
      },
    },
    requests: [],
    _sessionState: {},
    ...
    getUnionId: function (e) {
      var t = {},
        ...
        s = e._distinct_id || e.distinct_id;
      return r && s ? ((t.login_id = s), (t.anonymous_id = r)) : (t.anonymous_id = s), t;
    },
    getFirstId: function () {
    ...
    init: function () {
      ...
      var e = UUID(),
        ...
        r = safeJSONParse((t = cookie.resolveValue(t)));
      null === t || !isJSONString(t) || !isObject(r) || (isObject(r) && !r.distinct_id)
        ...
        : ((sd.store._state = extend(
            (function (e) {
              ...
              if (r.login_id)
                if (s && isObject(e.identities) && e.identities.hasOwnProperty(s)) {
                  if (e.identities[s] !== r.login_id) {
                    for (t in ((e.identities[s] = r.login_id), e.identities))
                  ...
                  for (t in ((e.identities[sd.para.login_id_key] = r.login_id), e.identities))
                    isObject(e.identities) &&
                      e.identities.hasOwnProperty(t) &&
                      '$identity_cookie_id' !== t &&
                      t !== sd.para.login_id_key &&
                      delete e.identities[t];
                  e.history_login_id = { name: sd.para.login_id_key, value: r.login_id };
                }
              else {
                if (
                  (isObject(e.identities) && e.identities.hasOwnProperty('$identity_login_id')) ||
  ...
  ruleOption = {
    ...
    reservedBind: function (e) {
      return (
        sdPara.login_id_key &&
          -1 === this.bindReservedNames.indexOf(sdPara.login_id_key) &&
          this.bindReservedNames.push(sdPara.login_id_key),
  ...
  checkOption = {
    ...
    propertyValue: {
      ...
      onComplete: function (e, t, r) {
        return (
          e || ('Property Value', isFunction(checkLog[r]) && checkLog[r]('Property Value')), !0
        );
      },
    },
    properties: function (e) {
      return (
        isObject(e)
          ? each(e, function (e, t) {
              check({ propertyKey: t });
              check({ propertyValue: e }, function (e, r, s) {
                return e || ((r = t + "'s Value"), isFunction(checkLog[s]) && checkLog[s](r)), !0;
              });
            })
    ...
    check: function (e, t, r) {
      var s = this[e];
      if (isFunction(s)) return s.call(this, t);
      if (!s) return !1;
      for (var i = 0; i < s.rules.length; i++) {
        var a = s.rules[i],
          n = ruleOption[a](t),
          o = isFunction(r) ? r(n, t, a) : s.onComplete(n, t, a);
        if (!n) return o;
      }
      return !0;
    },
...
function searchObjString(e) {
  ...
  isObject(e) &&
    each(e, function (s, i) {
      if (isObject(s)) searchObjString(e[i]);
      else if (isString(s)) {
        if (indexOf(r, i) > -1) return;
        e[i] = formatString(s, indexOf(t, i) > -1 ? 1024 : sdPara.max_string_length);
      }
    });
}
...
function formatItem(e) {
  ...
  if ('item_id' in e) {
    check({ item_id: e.item_id }, function (t, r, s) {
      return t || 'string' !== s || delete e.item_id, !0;
    });
  }
}
function formatProperties(e) {
  each(e, function (t, r) {
    check({ propertyKey: r }, function (t, s, i) {
...
(saEvent.check = check),
  (saEvent.sendItem = function (e) {
    ...
    extend(t, e), formatData(t), sd.sendState.getSendCall(t);
  }),
...
var heatmap = {
    ...
    getTargetElement: function (e, t) {
      ...
      var i = r.parentNode,
        a = this.hasElement({ event: (t && t.originalEvent) || t, element: e }, function (e) {
          return 'a' === e.tagName.toLowerCase() || hasAttributes(e, sd.para.heatmap.track_attr);
        }),
        n = this.otherTags;
      if ('a' === s || 'button' === s || 'input' === s || 'textarea' === s) return r;
      ...
      if (
        ...
        ry(i).prev().tagName &&
        'img' === ry(i).prev().tagName.toLowerCase()
      )
        return ry(i).prev();
      if (a) return a;
      if ('div' === s && sd.para.heatmap.collect_tags.div && this.isDivLevelValid(r))
    ...
    getDomIndex: function (e) {
      ...
      for (var t = 0, r = e.tagName, s = e.parentNode.children, i = 0; i < s.length; i++)
        if (s[i].tagName === r) {
          if (e === s[i]) return t;
          t++;
        }
    ...
    start: function (e, t, r, s, i) {
      var a = isObject(s) ? s : {},
        n = isFunction(i) ? i : isFunction(s) ? s : undefined;
          ...
          if (1 === e.children[r].nodeType) {
            var s = e.children[r].tagName.toLowerCase(),
              i =
                ...
                sd.para.heatmap.collect_tags.div &&
                sd.para.heatmap.collect_tags.div.max_level;
            if (!(('div' === s && i > 1) || this.isStyleTag(s, t))) return !1;
    ...
    getCollectableParent: function (e, t) {
      try {
        ...
        var i =
          ...
          sd.para.heatmap.collect_tags.div &&
          sd.para.heatmap.collect_tags.div.max_level;
        if (s && 'div' === s && (i > 1 || this.isCollectableDiv(r, t))) return r;
        ...
        t = (function (e) {
          ...
          func: function (e, t) {
            var r =
                ...
                0,
              s = new Date(),
              i = s - this.current_time;
            ((i > sd.para.heatmap.scroll_delay_time && r - e.$viewport_position != 0) || t) &&
              ((e.$url = getURL()),
    ...
    initHeatmap: function () {
      ...
      return (
        ...
        !(isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url()) &&
        ...
        void ('all' === sd.para.heatmap.collect_elements
          ? addEvent(document, 'click', function (t) {
              ...
              'a' === a || 'button' === a ? e.start(r, s.parentNode, a) : e.start(r, s, i);
            })
          : addEvent(document, 'click', function (t) {
              var r = t || window.event;
              if (!r) return !1;
              var s = r.target || r.srcElement,
                i = sd.heatmap.getTargetElement(s, t);
              i
                ...
                : isElement(s) &&
                  ...
                  e.start(r, s, s.tagName.toLowerCase(), { $lib_method: 'vtrack' });
            })))
      );
    },
  },
  commonWays = {
    ...
    setProfileLocal: function (e) {
      ...
      if (isObject(t) && !isEmptyObject(t)) {
        ...
        r &&
          (_localstorage.set('sensorsdata_2015_jssdk_profile', JSON.stringify(t)),
          sd.setProfile(e));
      } else
        _localstorage.set('sensorsdata_2015_jssdk_profile', JSON.stringify(e)), sd.setProfile(e);
    },
    ...
    autoTrackSinglePage: function (e, t) {
      ...
      function a(e, t) {
        sd.track(
          '$pageview',
          extend(
            { $referrer: r, $url: getURL(), $url_path: location.pathname, $title: document.title },
            e,
            s()
          ),
          t
...
function sendSignup(e, t, r, s) {
  var i = store.getFirstId() || store.getDistinctId();
  store.set('distinct_id', e),
    saEvent.send(
      { original_id: i, distinct_id: e, type: 'track_signup', event: t, properties: r },
      s
    );
}
(sd.para_default = defaultPara),
  ...
  (sd.IDENTITY_KEY = { EMAIL: '$identity_email', MOBILE: '$identity_mobile' }),
  (sd.bind = function (e, t) {
  ...
  (sd.unbind = function (e, t) {
    if (!saEvent.check({ bindKey: e, bindValue: t })) return !1;
    isObject(sd.store._state.identities) &&
      sd.store._state.identities.hasOwnProperty(e) &&
      sd.store._state.identities[e] === t &&
      (delete sd.store._state.identities[e], sd.store.save());
    var r = {};
    (r[e] = t),
      saEvent.send({ identities: r, type: 'track_id_unbind', event: '$UnbindID', properties: {} });
  }),
  (sd.trackLink = function (e, t, r) {
    function s(e, t, r) {
      ...
      if (
        ...
        return !1;
      if (!s.href || /^javascript/.test(s.href) || s.target || s.download || s.onclick)
  ...
  (sd.identify = function (e, t) {
    ...
    if (void 0 === e) {
      ...
      r ? store.set('first_id', s) : store.set('distinct_id', s),
        sd.store.identities.set('identify', s);
    } else
  ...
  (sd.trackSignup = function (e, t, r, s) {
    'number' == typeof e && (e = String(e)),
      saEvent.check({ distinct_id: e, event: t, properties: r }) && sendSignup(e, t, r, s);
  }),
  ...
  (sd.login = function (e, t) {
    if (
      ('number' == typeof e && (e = String(e)),
      saEvent.check({ distinct_id: e }) && e !== sd.store.getDistinctId())
    ) {
      if (
        isObject(sd.store._state.identities) &&
        sd.store._state.identities.hasOwnProperty(sd.para.login_id_key) &&
        e === sd.store._state.first_id
      )
        return t && t(), !1;
      if (
        sd.store._state.history_login_id.name !== sd.para.login_id_key ||
        e !== sd.store._state.history_login_id.value
      ) {
        sd.store._state.identities[sd.para.login_id_key] = e;
        var r = store.getFirstId(),
          s = store.getDistinctId();
        r || store.set('first_id', s),
          sendSignup(e, '$SignUp', {}, t),
          sd.store.identities.set('login', e),
          sd.store.set('history_login_id', { name: sd.para.login_id_key, value: e });
      }
    } else t && t();
    t && t();
  }),
  (sd.logout = function (e) {
    ...
    sd.store.identities.set('logout'), sd.store.set('history_login_id', { name: '', value: '' });
  }),
  ...
  (sd.iOSWebClickPolyfill = function () {
    ...
    sd.heatmap &&
      ...
      sd._.isIOS() &&
        ...
        sd.para.heatmap &&
          sd.para.heatmap.track_attr &&
          sd._.setCssStyle('[' + sd.para.heatmap.track_attr.join('], [') + ']' + t),
...
(sendState.queue = autoExeQueue()),
  (sendState.getSendCall = function (e, t, r) {
    ...
    var s = e;
    e = JSON.stringify(e);
    var i = { data: s, config: t, callback: r };
    if (
      (sd.events.tempAdd('send', s),
      !sd.para.app_js_bridge && sd.para.batch_send && localStorage.length < 200)
    )
      return sd.log(s), sd.batchSend.add(i.data), !1;
    'item_set' === s.type || 'item_delete' === s.type
      ? this.prepareServerUrl(i)
      : sd.bridge.dataSend(i, this, r),
      sd.log(s);
  }),
  ...
  (sendState.sendCall = function (e, t, r) {
    var s = { server_url: t, data: JSON.stringify(e.data), callback: r, config: e.config };
    isObject(sd.para.jsapp) && !sd.para.jsapp.isOnline && 'function' == typeof sd.para.jsapp.setData
  ...
  (BatchSend.prototype = {
    ...
    send: function (e) {
      ...
      (isArray(sd.para.server_url) && sd.para.server_url.length)
        ? ajax({
            url: isArray(sd.para.server_url) ? sd.para.server_url[0] : sd.para.server_url,
            type: 'POST',
            data: 'data_list=' + encodeURIComponent(base64Encode(JSON.stringify(e.vals))),
            credentials: !1,
    ...
    readStore: function () {
      for (
        ...
        if (0 === o.indexOf('sawebjssdk-') && /^sawebjssdk\-\d+$/.test(o)) {
          if (a.length && indexOf(a, o) > -1) continue;
...
var batchSend = new BatchSend(),
  bridge = {
    ...
    initPara: function () {
      ...
      'object' == typeof sd.para.app_js_bridge
        ...
        ? ((!1 !== sd.para.use_app_track_is_send && 'only' !== sd.para.use_app_track) ||
            (e.is_send = !1),
        ...
        if (e && e[0] && 'string' == typeof e[1] && 2 === e[1].split('?').length) {
          ...
          try {
            (t = _URL(sd.para.server_url).hostname),
              (r = _URL(sd.para.server_url).searchParams.get('project') || 'default');
          } catch (s) {
            sd.log(s);
          }
      ...
      if (isObject(sd.para.app_js_bridge) && !sd.para.app_js_bridge.is_mui)
        if (
          ...
          sd.bridge.is_verify_success
            ...
            ? (sd.debug.apph5({ data: s, step: '4.1', output: 'all' }), t.prepareServerUrl(e))
            : 'function' == typeof r && r();
        else if (
          isObject(window.SensorsData_APP_New_H5_Bridge) &&
          window.SensorsData_APP_New_H5_Bridge.sensorsdata_get_server_url &&
          ...
          sd.bridge.is_verify_success
            ? (SensorsData_APP_New_H5_Bridge.sensorsdata_track(
              ...
              'function' == typeof r && r())
            : sd.para.app_js_bridge.is_send
            ? (sd.debug.apph5({ data: s, step: '4.2', output: 'all' }), t.prepareServerUrl(e))
            : 'function' == typeof r && r();
        else if (
          'object' == typeof SensorsData_APP_JS_Bridge &&
          (SensorsData_APP_JS_Bridge.sensorsdata_verify ||
          ...
          SensorsData_APP_JS_Bridge.sensorsdata_verify
            ? SensorsData_APP_JS_Bridge.sensorsdata_verify(
              ...
              ? 'function' == typeof r && r()
              : sd.para.app_js_bridge.is_send
              ? (sd.debug.apph5({ data: s, step: '3.1', output: 'all' }), t.prepareServerUrl(e))
              : 'function' == typeof r && r()
            : (SensorsData_APP_JS_Bridge.sensorsdata_track(
                JSON.stringify(extend({ server_url: sd.para.server_url }, s))
              ),
          ...
          isObject(sd.para.app_js_bridge) && !0 === sd.para.app_js_bridge.is_send
            ? (sd.debug.apph5({ data: s, step: '2', output: 'all' }), t.prepareServerUrl(e))
            : 'function' == typeof r && r();
        else {
          var i = null;
          if (sd.bridge.iOS_UA_bridge()) {
            ...
            var a = (function (e) {
              var t = JSON.stringify(extend({ server_url: sd.para.server_url }, e));
              return (
                (t = t.replaceAll(/\r\n/g, '')),
                'sensorsanalytics://trackEvent?event=' + (t = encodeURIComponent(t))
              );
            })(s);
            ...
            sd.para.app_js_bridge.is_send
              ? (sd.debug.apph5({ data: s, step: '3.2', output: 'all' }), t.prepareServerUrl(e))
              : 'function' == typeof r && r();
        }
      else
        isObject(sd.para.app_js_bridge) && sd.para.app_js_bridge.is_mui
          ? isObject(window.plus) && window.plus.SDAnalytics && window.plus.SDAnalytics.trackH5Event
            ? (window.plus.SDAnalytics.trackH5Event(e), 'function' == typeof r && r())
            : isObject(sd.para.app_js_bridge) && !0 === sd.para.app_js_bridge.is_send
            ? t.prepareServerUrl(e)
            : 'function' == typeof r && r()
          : (sd.debug.apph5({ data: s, step: '1', output: 'code' }), t.prepareServerUrl(e));
    },
  ...
  JSBridge = function (e) {
    (this.list = {}),
      (this.type = e.type),
      (this.app_call_js = isFunction(e.app_call_js) ? e.app_call_js : function () {}),
      this.init();
  };
  ...
  (JSBridge.prototype.requestToApp = function (e) {
    ...
    isFunction(e.callback) || (e.callback = function () {}),
      isObject(e.timeout) &&
        ...
        (isFunction(e.timeout.callback) || (e.timeout.callback = function () {}),
...
var vtrackBase = {
    initUrl: function () {
      ...
      try {
        ...
        return sd.log('----vcollect---server_url\u89e3\u6790\u5f02\u5e38', s), !1;
      }
      try {
        ...
        return sd.log('----vcollect---\u9875\u9762\u5730\u5740\u89e3\u6790\u5f02\u5e38', s), !1;
      }
      return r;
    },
    isDiv: function (e) {
    ...
    getProp: function (e, t) {
      ...
      if ('content' === e.method) {
        ...
        if ('input' === a.tagName.toLowerCase()) r = a.value || '';
          ...
          isNumber(d) && isElement(a[d]) && (r = getElementContent(a[d], 'select'));
        } else r = getElementContent(a, a.tagName.toLowerCase());
        if (e.regular) {
          try {
      ...
      this.sendRequest(
        function (t, r) {
          ...
          200 === t
            ...
            : 304 === t
            ? (s = e.config)
            : (sd.log('----vtrackcustom----\u6570\u636e\u5f02\u5e38', t), e.updateConfig(s)),
            e.updateStorage(s),
            e.setNextFetch();
        },
        function (t) {
      ...
      return new sd.JSBridge({
        ...
        app_call_js: function (t) {
          ...
          if (isObject(t)) {
            ...
            i &&
              ...
              isArray(s) &&
                s.length > 0 &&
                each(s, function (t) {
                  if (isObject(t) && t.url_host === i.host && t.url_path === i.pathname && t.h5) {
                    var s = e.getProp(t);
          ...
          if ('android' === sd.bridge.bridge_info.platform) {
            var a = { callType: 'getJSVisualProperties', data: r };
            isObject(t) && t.message_id && (a.message_id = t.message_id),
              isObject(window.SensorsData_APP_New_H5_Bridge) &&
              isFunction(SensorsData_APP_New_H5_Bridge.sensorsdata_js_call_app)
                ? SensorsData_APP_New_H5_Bridge.sensorsdata_js_call_app(JSON.stringify(a))
                : isObject(window.SensorsData_APP_JS_Bridge) &&
                  isFunction(SensorsData_APP_JS_Bridge.sensorsdata_js_call_app) &&
                  SensorsData_APP_JS_Bridge.sensorsdata_js_call_app(JSON.stringify(a));
          }
          return r;
        },
      });
  ...
  vapph5collect = {
    ...
    getConfigFromApp: function () {
      var e = new sd.JSBridge({ type: 'sensorsdata_get_app_visual_config' }).getAppData();
      if (e)
        try {
      ...
      heatmap.setNotice(r),
        _sessionStorage.isSupport() &&
          (r &&
            r[0] &&
            r[1] &&
            sessionStorage.setItem('sensors_heatmap_url', _decodeURIComponent(r[1])),
  ...
  vtrackMode = {
    ...
    loadVtrack: function () {
      loadScript({
        ...
        url: sd.para.vtrack_url
          ? sd.para.vtrack_url
          : location.protocol + '//static.sensorsdata.cn/sdk/' + sd.lib_version + '/vtrack.min.js',
      });
    },
    ...
    postMessage: function () {
      window.parent &&
        ...
        window.parent.postMessage(
          { source: 'sa-web-sdk', type: 'v-is-vtrack', data: { sdkversion: '1.20.3' } },
          '*'
        );
    },
    notifyUser: function () {
...
function defineMode(e) {
  ...
  function r() {
    ...
    SensorsData_App_Visual_Bridge && SensorsData_App_Visual_Bridge.sensorsdata_visualized_alert_info
      ? SensorsData_App_Visual_Bridge.sensorsdata_visualized_alert_info(JSON.stringify(r))
      : window.webkit &&
        window.webkit.messageHandlers &&
        window.webkit.messageHandlers.sensorsdataNativeTracker &&
        window.webkit.messageHandlers.sensorsdataNativeTracker.postMessage &&
...
(sd.modules = {}),
        ...
        eventList: {
          init: function () {
            ...
            if (t && e.isNumber(t.latest_event_initial_time) && e.isArray(t.eventList)) {
              var i = s - t.latest_event_initial_time;
  ...
  (sd.modules.Deeplink = (function () {
    ...
    var s = { android: /Android/i, iOS: /iPhone|iPad|iPod/i },
      ...
      n = {
        ...
        init: function () {
          ...
          if (
            (a(sensorsDataAnalytic201505) && (this.sd = sensorsDataAnalytic201505),
            this.log('init()'),
            null === this.sd)
          )
          ...
          if (
            (arguments.length > 0 &&
              (1 === arguments.length && a(arguments[0])
                ? (e = arguments[0])
                : arguments.length >= 2 && a(arguments[1]) && (e = arguments[1])),
            !s.hasOwnProperty(i))
          )
            return (
              this.log(
    ...
    return (
      a(window.SensorsDataWebJSSDKPlugin)
        ...
        for (var e = window.localStorage.length, t = 0; t < e; t++) {
          ...
          if (
            ...
            this._.isObject(s) &&
              ...
              (delete s.heartbeat_interval_time, this.sd.kit.sendData(s), this.delHeartBeatData(r));
          }
        }
      }),
      ...
      getCurrenId: function () {
        ...
        return (
          this._.urlSafeBase64 && this._.urlSafeBase64.encode
            ? (e = e
                ? this._.urlSafeBase64.trim(this._.urlSafeBase64.encode(_.base64Encode(e)))
                : '')
          ...
          if (this.getPartHash(e))
            (i = o.indexOf('_sasdk')),
              (s =
                o.indexOf('?') > -1
                  ? i > -1
                    ? a + n + '#' + o.substring(1, i) + '_sasdk=' + this.getCurrenId()
                    : a + n + '#' + o.substring(1) + '&_sasdk=' + this.getCurrenId()
                  : a + n + '#' + o.substring(1) + '?_sasdk=' + this.getCurrenId());
          else
            (i = n.indexOf('_sasdk')),
              (s = /^\?(\w)+/.test(n)
                ? i > -1
                  ? a + '?' + n.substring(1, i) + '_sasdk=' + this.getCurrenId() + o
                  : a + '?' + n.substring(1) + '&_sasdk=' + this.getCurrenId() + o
                : a + '?' + n.substring(1) + '_sasdk=' + this.getCurrenId() + o);
          return t && (t.href = s), s;
        }
      },
          ...
          return (
            !t ||
              ...
              this._.urlSafeBase64.isUrlSafeBase64(t)
                ? (t =
                    t.substring(0, 1) + _.base64Decode(this._.urlSafeBase64.decode(t.substring(1))))
        ...
        var e = this,
          t = function (t) {
            ...
            if (
              ...
              'a' === a && i.href ? ((r = i.href), (s = i)) : ((r = n.href), (s = n));
              var o = e._.URL(r).protocol;
              ('http:' !== o && 'https:' !== o) || (e.getPart(r) && e.rewireteUrl(r, s));
            }
          };
          ...
          this._.isObject(t) && this._.isArray(t.linker) && t.linker.length > 0
            ? (this.setRefferId(),
              ...
              (this.option = (function (t) {
                for (var r = t.length, s = [], i = 0; i < r; i++)
